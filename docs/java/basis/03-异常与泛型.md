...
关于反射的详细解读，请看这篇文章 [Java 反射机制详解](./04-反射.md) 。
...
关于 SPI 的详细解读，请看这篇文章 [Java SPI 机制详解](./06-spi.md) 。
...
相关阅读：[Java IO 基础知识总结](../io/01-io基础.md)。
...
[Java IO 设计模式总结](../io/02-io设计模式.md)

### BIO、NIO 和 AIO 的区别？

[Java IO 模型详解](../io/03-io模型.md)
...
关于这些语法糖的详细解读，请看这篇文章 [Java 语法糖详解](./11-语法糖.md) 。